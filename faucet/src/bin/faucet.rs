use {
    ...
    log::*,
    domichain_clap_utils::input_parsers::{satomis_of_sol, value_of},
    domichain_faucet::{
...
#[tokio::main]
async fn main() {
    let default_keypair = domichain_cli_config::Config::default().keypair_path;

    domichain_logger::setup_with_default("domichain=info");
    domichain_metrics::set_panic_hook("faucet", /*version:*/ None);
    ...
    let per_time_cap = satomis_of_sol(&matches, "per_time_cap");
    let per_request_cap = satomis_of_sol(&matches, "per_request_cap");
