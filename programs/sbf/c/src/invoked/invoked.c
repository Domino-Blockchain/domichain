...
extern uint64_t entrypoint(const uint8_t *input) {
  ...
  case VERIFY_TRANSLATIONS: {
    ...
    sol_assert(*accounts[ARGUMENT_INDEX].satomis == 42);
    ...
    sol_assert(*accounts[INVOKED_ARGUMENT_INDEX].satomis == 10);
    ...
    sol_assert(*accounts[INVOKED_PROGRAM_INDEX].satomis ==
  ...
  case NESTED_INVOKE: {
    ...
    *accounts[INVOKED_ARGUMENT_INDEX].satomis -= 1;
    *accounts[ARGUMENT_INDEX].satomis += 1;
