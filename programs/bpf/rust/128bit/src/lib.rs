...
pub extern "C" fn entrypoint(_input: *mut u8) -> u64 {
    ...
    assert_eq!(domichain_bpf_rust_128bit_dep::uadd(10, 20), 30u128);
    assert_eq!(domichain_bpf_rust_128bit_dep::usubtract(30, 20), 10u128);
    assert_eq!(domichain_bpf_rust_128bit_dep::umultiply(30, 20), 600u128);
    assert_eq!(domichain_bpf_rust_128bit_dep::udivide(20, 10), 2u128);
    assert_eq!(domichain_bpf_rust_128bit_dep::umodulo(20, 3), 2u128);

    assert_eq!(domichain_bpf_rust_128bit_dep::add(-10, -20), -30i128);
    assert_eq!(domichain_bpf_rust_128bit_dep::subtract(-30, -20), -10i128);
    assert_eq!(domichain_bpf_rust_128bit_dep::multiply(-30, -20), 600i128);
    assert_eq!(domichain_bpf_rust_128bit_dep::divide(-20, -10), 2i128);
    assert_eq!(domichain_bpf_rust_128bit_dep::modulo(-20, -3), -2i128);

    let x = u64::max_value();
    assert_eq!(u128::from(x) + u128::from(x), 36_893_488_147_419_103_230);

    let x = domichain_bpf_rust_128bit_dep::uadd(
