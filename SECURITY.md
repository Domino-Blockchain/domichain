...
* Explorer: `/explorer` in the monorepo as well as https://explorer.domichain.io
...
* The DOMI/USD conversion rate used for payments is the market price of DOMI (denominated in USD) at the end of the day the invoice is submitted by the researcher.
...
* Bug bounties that are paid out in DOMI are paid to stake accounts with a lockup expiring 12 months from the date of delivery of DOMI.
