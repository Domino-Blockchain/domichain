...
#[cfg(feature = "spinner")]
use {crate::spinner, domichain_sdk::clock::MAX_HASH_AGE_IN_SECONDS, std::cmp::min};
use {
    crate::{
...
impl RpcClient {
    ...
    /// ```
    /// # use domichain_rpc_client_api::client_error::Error;
    /// # use domichain_rpc_client::nonblocking::rpc_client::{self, RpcClient};
    /// # use domichain_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
