...
use {
    ...
    domichain_gossip::cluster_info::{ClusterInfo, MAX_LEGACY_SNAPSHOT_HASHES},
...
impl SnapshotPackagerService {
    ...
    pub fn new(
        ...
        let t_snapshot_packager = Builder::new()
            .name("domiSnapshotPkgr".to_string())
            .spawn(move || {
...
mod tests {
    use {
        ...
        domichain_sdk::{clock::Slot, genesis_config::GenesisConfig, hash::Hash},
        std::{
