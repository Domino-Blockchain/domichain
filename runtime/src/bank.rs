...
impl Bank {
    ...
    fn program_modification_slot(&self, pubkey: &Pubkey) -> Result<Slot> {
        ...
        if wasm_loader_upgradeable::check_id(program.owner()) {
            ...
            let state = domichain_loader_v4_program::get_state(program.data())
    ...
    pub fn calculate_fee(
        ...
        if is_vote {
            ...
            // Use the vote-specific fee calculation
   ...
   let mut valid_risk_scores = Vec::new();

   // Check if the account entry exists and gather valid risk scores
   {
    ...
    fn collect_rent_from_accounts(
        ...
        let set_exempt_rent_epoch_max: bool = self
            .feature_set
            .is_active(&domichain_sdk::feature_set::set_exempt_rent_epoch_max::id());
    ...
    fn apply_builtin_program_feature_transitions(
        ...
        const FEATURES_AFFECTING_RBPF: &[Pubkey] = &[
            ...
            feature_set::disable_bpf_account_data_direct_mapping::id(),
...
pub mod test_utils {
    use {
        super::Bank,
        domichain_sdk::{hash::hashv, pubkey::Pubkey},
        domichain_vote_program::vote_state::{self, BlockTimestamp, VoteStateVersions},
    };
