...
pub fn calculate_non_circulating_supply(bank: &Arc<Bank>) -> ScanResult<NonCirculatingSupply> {
        ...
        .contains(&AccountIndex::ProgramId)
    {
        bank.get_filtered_indexed_accounts(
            ...
            // zero-satomi Account::Default() after being wiped and reinitialized in later
    ...
    let satomis = non_circulating_accounts_set
        .iter()
...
mod tests {
    use {
        super::*,
        crate::genesis_utils::genesis_sysvar_and_builtin_program_satomis,
        domichain_sdk::{
    ...
    fn test_calculate_non_circulating_supply() {
        ...
        assert_eq!(
            non_circulating_supply.satomis,
