use {
    ...
    domichain_faucet::faucet::run_local_faucet_with_port,
    domichain_rpc::{
        rpc::{JsonRpcConfig, RpcBigtableConfig},
        rpc_pubsub_service::PubSubConfig,
    },
    domichain_rpc_client::rpc_client::RpcClient,
    domichain_runtime::accounts_index::{AccountIndex, AccountSecondaryIndexes},
    domichain_sdk::{
...
fn main() {
    ...
    let version = domichain_version::version!();
