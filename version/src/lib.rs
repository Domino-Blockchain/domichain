...
use {
    ...
    domichain_sdk::{sanitize::Sanitize, serde_varint},
...
impl Default for Version {
    fn default() -> Self {
        let feature_set = u32::from_le_bytes(
            domichain_sdk::feature_set::ID.as_ref()[..4]
                .try_into()
                .unwrap(),
        );
        Self {
            ...
            client: u16::try_from(ClientId::DomichainLabs).unwrap(),
        }
    }
}
...
impl TryFrom<ClientId> for u16 {
    ...
    fn try_from(client: ClientId) -> Result<Self, Self::Error> {
        match client {
            ClientId::DomichainLabs => Ok(0u16),
...
mod test {
    ...
    #[test]
    fn test_client_id() {
        assert_eq!(ClientId::from(0u16), ClientId::DomichainLabs);
        ...
        assert_eq!(u16::try_from(ClientId::DomichainLabs), Ok(0u16));
