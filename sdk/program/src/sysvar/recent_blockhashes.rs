...
//!
//! See also the Domichain [documentation on the recent blockhashes sysvar][sdoc].
//!
...
impl Entry {
    pub fn new(blockhash: &Hash, satomis_per_signature: u64) -> Self {
        Self {
            blockhash: *blockhash,
...
impl Sysvar for RecentBlockhashes {
    fn size_of() -> usize {
        ...
        7208 // golden, update if MAX_ENTRIES changes
    }
}
