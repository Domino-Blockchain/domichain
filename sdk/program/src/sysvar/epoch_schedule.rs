...
//!
//! See also the Domichain [documentation on the epoch schedule sysvar][sdoc].
//!
...
//! }
//! #
//! # use domichain_program::sysvar::SysvarId;
...
//! # use domichain_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
