//! An upgradeable WASM loader native program.
//!
//! The upgradeable WASM loader is responsible for deploying, upgrading, and
//! executing WASM programs. The upgradeable loader allows a program's authority
...
//!
//! The `domichain deploy` and `domichain program deploy` CLI commands use the
//! upgradeable WASM loader. Calling `domichain program deploy --final` deploys a
...
crate::declare_id!("WASMLoaderUpgradeab1e1111111111111111111111");
