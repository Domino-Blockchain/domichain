use {
    ...
    domichain_cli_output::{CliAddressLookupTable, CliAddressLookupTableCreated, CliSignature},
    domichain_remote_wallet::remote_wallet::RemoteWalletManager,
    domichain_rpc_client::rpc_client::RpcClient,
    domichain_rpc_client_api::config::RpcSendTransactionConfig,
    domichain_sdk::{
...
fn process_freeze_lookup_table(
    ...
    if !domichain_address_lookup_table_program::check_id(&lookup_table_account.owner) {
        return Err(format!(
