...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Domichain signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Domichain signer used to generate an authenticated encryption key.
    ///
