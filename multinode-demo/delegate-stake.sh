...
stake_sol=10   # default number of DOMI to assign as stake (10 DOMI)
...
usage: $0 [OPTIONS] <DOMI to stake ($stake_sol)>
...
VALIDATOR_KEYS_DIR=$DOMICHAIN_CONFIG_DIR/validator$label
...
if ((airdrops_enabled)); then
  ...
  $domichain_cli \
    "${common_args[@]}" --keypair "$DOMICHAIN_CONFIG_DIR/faucet.json" \
