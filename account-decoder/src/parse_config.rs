use {
    ...
    bincode::deserialize,
    serde_json::Value,
    domichain_config_program::{get_config_data, ConfigKeys},
    domichain_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        domichain_config_program::create_config_account, domichain_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = domichain_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Domichain"}"#).unwrap(),
            }),
        );
