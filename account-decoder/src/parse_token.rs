...
// A helper function to convert a domichain_sdk::pubkey::Pubkey to spl_sdk::pubkey::Pubkey
...
// A helper function to convert a spl_sdk::pubkey::Pubkey to domichain_sdk::pubkey::Pubkey
#[deprecated(since = "1.16.0", note = "Pubkey conversions no longer needed")]
...
pub fn parse_token(
    ...
    _parse_token(data, mint_decimals)
}
