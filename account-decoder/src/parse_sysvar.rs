#[allow(deprecated)]
use domichain_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
#[serde(rename_all = "camelCase")]
pub struct UiRent {
    pub satomis_per_byte_year: StringAmount,
...
impl From<Rent> for UiRent {
    fn from(rent: Rent) -> Self {
        Self {
            satomis_per_byte_year: rent.satomis_per_byte_year.to_string(),
...
mod test {
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = domichain_sdk::pubkey::new_rand();
