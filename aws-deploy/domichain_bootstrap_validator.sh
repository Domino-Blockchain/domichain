...
screen -d -m -S bootstrap-validator bash -c './multinode-demo/bootstrap-validator.sh --gossip-host $NODE_IP_ADDR --enable-rpc-transaction-history --limit-ledger-size 50000000 >stdout.txt 2>stderr.txt'
