---
title: Using Domichain CLI
---

Before running any Domichain CLI commands, let's go over some conventions that
you will see across all commands. First, the Domichain CLI is actually a collection
...
```bash
domichain-keygen pubkey <KEYPAIR>
```
...
`/home/domichain/my_wallet.json`, to display the address, do:

```bash
domichain-keygen pubkey /home/domichain/my_wallet.json
```
