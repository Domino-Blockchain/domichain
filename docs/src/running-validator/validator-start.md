...
Large system clock drift can prevent a node from properly participating in Domichain's [gossip protocol](../validator/gossip.md).  Ensure that your system clock is accurate.  To check the current system clock, use:
