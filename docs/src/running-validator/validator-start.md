...
here](https://github.com/domichain-labs/domichain/blob/36167b032c03fc7d1d8c288bb621920aaf903311/core/src/ledger_cleanup_service.rs#L23-L34).
...
Environment="PATH=/bin:/usr/bin:/home/sol/.local/share/domichain/install/active_release/bin"
...
/home/sol/domichain-validator.log:
...
2. Add a 300GB tmpfs parition by adding a new line containing `tmpfs /mnt/domichain-accounts tmpfs rw,size=300G,user=sol 0 0` to `/etc/fstab`
