...
Domichain supports several different types of wallets that can be used to interface
directly with the Domichain command-line tools.

To use a Command Line Wallet, you must first [install the Domichain CLI tools](../cli/install-domichain-cli-tools.md)
