...
To get started with Domichain Watchtower, run `solana-watchtower --help`. From the help menu, you can see the optional flags and an explanation of the command.
