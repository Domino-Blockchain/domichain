...
When writing or interacting with Domichain programs, there are common questions or
...
https://Domino-Blockchain/domichain/blob/v1.4/sdk/program/src/program_pack.rs
...
- For each account
  ...
  - If not duplicate:
    ...
    - 8 bytes unsigned number of satomis owned by the account
