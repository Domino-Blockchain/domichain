...
The `@domichain/web3.js` library is a package that has coverage over the [Domichain JSON RPC API](https://docs.domichain.com/developing/clients/jsonrpc-api).
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Connection.html)

Connection is used to interact with the [Domichain JSON RPC](https://docs.domichain.com/developing/clients/jsonrpc-api). You can use Connection to confirm transactions, get account info, and more.
...
The above example shows only a few of the methods on Connection. Please see the [source generated docs](https://domichain-labs.github.io/domichain-web3.js/classes/Connection.html) for the full list.

### Transaction

[SourceDocumentation](https://domichain-labs.github.io/domichain-web3.js/classes/Transaction.html)
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Keypair.html)
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@domichain/web3.js` in transactions, keypairs, and programs. You require publickey when listing each account in a transaction and as a general identifier on Domichain.
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Message.html)
...
[SourceDocumentation](https://domichain-labs.github.io/domichain-web3.js/classes/Struct.html)
...
import {Struct} from '@domichain/web3.js';
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Enum.html)
...
Web3:
```javascript
import {Enum} from '@domichain/web3.js';
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/NonceAccount.html)
...
[SourceDocumentation](https://domichain-labs.github.io/domichain-web3.js/classes/VoteAccount.html)
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Authorized.html)
...
[Source Documentation](https://domichain-labs.github.io/domichain-web3.js/classes/Lockup.html)
...
```javascript
const {Authorized, Keypair, Lockup, StakeProgram} = require("@domichain/web3.js");
