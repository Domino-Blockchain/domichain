...
Domichain exposes a variety of cluster state data to programs via
...
[`domichain-program`
crate](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/domichain-program/VERSION_FOR_DOCS_RS/domichain_program/stake_history/struct.StakeHistory.html)
