...
- `<object>` - if transaction is confirmed, an object with the following fields:
  ...
  - `meta: <object|null>` - transaction status metadata object:
    - `err: <object|null>` - Error if transaction failed, null if transaction succeeded. [TransactionError definitions](https://docs.rs/solana-sdk/VERSION_FOR_DOCS_RS/domichain_sdk/transaction/enum.TransactionError.html)
