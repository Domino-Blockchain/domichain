...
Based on these considerations and the community discussions following the initial [design](https://forums.solana.com/t/solana-inflation-design-overview/920), the Domichain Foundation proposes the following Inflation Schedule parameters:
