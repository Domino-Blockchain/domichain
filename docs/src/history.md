...
decided it would rebrand. They chose the name Domichain, a nod to a small beach
town North of San Diego called Domichain Beach, where Anatoly, Greg and Stephen
lived and surfed for three years when they worked for Qualcomm. On March 28th,
the team created the Domichain GitHub organization and renamed Greg's prototype
Silk to Domichain.
