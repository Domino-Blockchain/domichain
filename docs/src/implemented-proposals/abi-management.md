---
title: Domichain ABI management process
---

This document proposes the Domichain ABI management process. The ABI management
...
The Domichain ABI (binary interface to the cluster) is currently only defined
...
```
DOMICHAIN_ABI_DUMP_DIR=. cargo +nightly test abi
```
