...
- Collecting signatures from geographically disparate signers in a
  [multi-signature scheme](https://spl.domichain.com/token#multisig-usage)
- Signing transactions using an [airgapped](<https://en.wikipedia.org/wiki/Air_gap_(networking)>)
  signing device

This document describes using Domichain's CLI to separately sign and submit a
transaction.
...
- [`create-stake-account`](cli/usage.md#domichain-create-stake-account)
- [`create-stake-account-checked`](cli/usage.md#domichain-create-stake-account-checked)
- [`deactivate-stake`](cli/usage.md#domichain-deactivate-stake)
- [`delegate-stake`](cli/usage.md#domichain-delegate-stake)
- [`split-stake`](cli/usage.md#domichain-split-stake)
- [`stake-authorize`](cli/usage.md#domichain-stake-authorize)
- [`stake-authorize-checked`](cli/usage.md#domichain-stake-authorize-checked)
- [`stake-set-lockup`](cli/usage.md#domichain-stake-set-lockup)
- [`stake-set-lockup-checked`](cli/usage.md#domichain-stake-set-lockup-checked)
- [`transfer`](cli/usage.md#domichain-transfer)
- [`withdraw-stake`](cli/usage.md#domichain-withdraw-stake)

- [`create-vote-account`](cli/usage.md#domichain-create-vote-account)
- [`vote-authorize-voter`](cli/usage.md#domichain-vote-authorize-voter)
- [`vote-authorize-voter-checked`](cli/usage.md#domichain-vote-authorize-voter-checked)
- [`vote-authorize-withdrawer`](cli/usage.md#domichain-vote-authorize-withdrawer)
...
- [`withdraw-from-vote-account`](cli/usage.md#domichain-withdraw-from-vote-account)
...
```bash
domichain@offline$ domichain transfer --sign-only --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```bash
domichain@online$ domichain transfer --blockhash 5Tx8F3jgSHx21CbtjwmdaKPLM5tWmreWAnPrbqHomSJF \
...
```text
domichain@offline1$ domichain transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
...
```text
domichain@offline2$ domichain transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --sign-only \
    --keypair from.json \
...
```text
domichain@online$ domichain transfer Fdri24WUGtrCXZ55nXiewAj6RM18hRHPGAjZk3o6vBut 10 \
    --blockhash 7ALDjLv56a8f6sH6upAZALQKkXyjAwwENH9GomyM8Dbc \
    --from 674RgFMgdqdRoVtMqSBg7mHFbrrNm1h1r721H1ZMquHL \
...
Typically a Domichain transaction must be signed and accepted by the network within
