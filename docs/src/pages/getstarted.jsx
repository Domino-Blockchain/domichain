    ...
    >
      <section className={styles.features}>
        <div className="container">
          <section>
            <h1>Get started with Domichain development</h1>
          ...
          <section className="">
            ...
            <Card
                ...
                body={{
                  label:
                    "Learn the basics of developing on the Domichain blockchain.",
              ...
              <Card
                ...
                body={{
                  label:
                    "Write and deploy your first Domichain program directly in your browser. No install needed.",
              ...
              <Card
                ...
                body={{
                  label:
                    "Build and deploy an on chain Domichain program with the Rust language.",
          ...
          <section className="">
            ...
            <div className="row cards__container">
              <Card
                ...
                body={{
                  label: "Rust based framework for writing Domichain programs.",
              ...
              <Card
                ...
                body={{
                  label: "Write Anchor-compatible Domichain programs in Python.",
              ...
              <Card
                ...
                header={{
                  label: "Domichain Playground",
                  translateId: "developer-examples",
                }}
                body={{
                  label:
                    "Quickly develop, deploy and test Domichain programs from the browser.",
