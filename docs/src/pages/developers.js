    ...
    >
      <section className={styles.features}>
        <div className="container">
          <section>
            <h1>Learn Domichain Development</h1>

            <div className="container__spacer">
              <p>
                Build and deploy your first on chain Domichain program directly in
                your browser.
              </p>
          ...
          <section className="">
            ...
            <div className="row cards__container">
              <Card
                ...
                body={{
                  label: "Discover what Domichain programs are and how they work.",
              ...
              <Card
                ...
                body={{
                  label:
                    "Understand how programs store data or state on the Domichain blockchain.",
          ...
          <section className="">
            ...
            <div className="row cards__container">
              <Card
                ...
                body={{
                  label:
                    "Start developing on-chain Domichain programs with Rust or C/C++.",
                  translateId: "start-building",
                }}
              />
              ...
              <Card
                ...
                body={{
                  label:
                    "Example of how to use code to interact with the Domichain blockchain.",
          ...
          <section className="">
            ...
            <div className="row cards__container">
              <Card
                ...
                header={{
                  label: "Domichain Test Validator",
                  translateId: "developer-test-validator",
                }}
                body={{
                  label:
                    "Quickly setup and run a self contained local Domichain blockchain for faster development.",
              ...
              <Card
                ...
                body={{
                  label:
                    "Interact with the Domichain clusters via the JSON RPC API.",
              ...
              {/* <Card
                ...
                body={{
                  label:
                    "Explore the essential developer tools for building and deploying Domichain programs.",
