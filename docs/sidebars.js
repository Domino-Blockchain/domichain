module.exports = {
  ...
  introductionSidebar: [
    {
      type: "category",
      collapsed: false,
      label: "Introduction to Domichain",
      items: [
        {
          type: "doc",
          id: "introduction",
          label: "What is Domichain?",
        },
    ...
    },
    {
      type: "category",
      collapsed: false,
      label: "Getting started with Domichain",
      items: [
        {
          type: "doc",
          id: "wallet-guide",
        ...
        // This will be the future home of the `staking` page, with the introductory info on what staking on Domichain looks like
        // {
        //   type: "doc",
        //   id: "staking",
        //   label: "Staking",
  ...
  cliSidebar: [
    "cli",
    "cli/install-domichain-cli-tools",
    {
      type: "category",
  ...
  architectureSidebar: [
    {
      type: "doc",
      label: "What is a Domichain Cluster?",
      id: "cluster/overview",
    },
    {
      type: "category",
