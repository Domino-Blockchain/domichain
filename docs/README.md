# Domichain Docs Readme

Domichain's Docs are built using [Docusaurus v2](https://v2.docusaurus.io/) with `npm`.
Static content delivery is handled using `vercel`.

## Local Development

To set up the Domichain Docs site locally:
...
Running this build script requires **Docker**, and will auto fetch the [domichainlabs/rust](https://hub.docker.com/r/domichainlabs/rust) image from Docker hub to compile the desired version of the [Domichain CLI](https://docs.domichain.com/cli) from source.

This build script will also:

- generate the `cli/usage.md` document from the output of each of the Domichain CLI commands and sub-commands
...
- Master branch docs are published to `edge.docs.domichain.com`
- Beta branch docs are published to `beta.docs.domichain.com`
- Latest release tag docs are published to `docs.domichain.com`
